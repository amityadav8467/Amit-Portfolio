        ...
        <div className="max-w-4xl mx-auto">
          <div className="animate-fadeIn text-center">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
              Hi — I'm <span className="text-blue-600">Amit Yadav</span>
            </h1>
            <p className="text-2xl sm:text-3xl text-gray-700 mb-4 font-medium">
              BCA Student • Junior Web Developer
            </p>
            <p className="text-lg sm:text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
              I build clean, responsive web experiences using HTML, CSS, JavaScript, and Python.
            </p>
